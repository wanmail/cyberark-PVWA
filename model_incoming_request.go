...
// IncomingRequest struct for IncomingRequest
type IncomingRequest struct {
	RequestorFullName *string `json:"RequestorFullName,omitempty"`
...
// GetRequestorFullName returns the RequestorFullName field value if set, zero value otherwise.
func (o *IncomingRequest) GetRequestorFullName() string {
	if o == nil || o.RequestorFullName == nil {
		var ret string
		return ret
	}
	return *o.RequestorFullName
}

// GetRequestorFullNameOk returns a tuple with the RequestorFullName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IncomingRequest) GetRequestorFullNameOk() (*string, bool) {
	if o == nil || o.RequestorFullName == nil {
		return nil, false
	}
	return o.RequestorFullName, true
}
...
// SetRequestorFullName gets a reference to the given string and assigns it to the RequestorFullName field.
func (o *IncomingRequest) SetRequestorFullName(v string) {
	o.RequestorFullName = &v
}
...
func (o IncomingRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.RequestorFullName != nil {
		toSerialize["RequestorFullName"] = o.RequestorFullName
	}
	if o.RequestID != nil {
...
type NullableIncomingRequest struct {
	value *IncomingRequest
	isSet bool
}

func (v NullableIncomingRequest) Get() *IncomingRequest {
	return v.value
}

func (v *NullableIncomingRequest) Set(val *IncomingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableIncomingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableIncomingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncomingRequest(val *IncomingRequest) *NullableIncomingRequest {
	return &NullableIncomingRequest{value: val, isSet: true}
}

func (v NullableIncomingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncomingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
