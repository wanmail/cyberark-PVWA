...
// UpdateSafeResponse struct for UpdateSafeResponse
...
func (o UpdateSafeResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateSafeResponse struct {
	value *UpdateSafeResponse
	isSet bool
}

func (v NullableUpdateSafeResponse) Get() *UpdateSafeResponse {
	return v.value
}

func (v *NullableUpdateSafeResponse) Set(val *UpdateSafeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSafeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSafeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSafeResponse(val *UpdateSafeResponse) *NullableUpdateSafeResponse {
	return &NullableUpdateSafeResponse{value: val, isSet: true}
}

func (v NullableUpdateSafeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSafeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
